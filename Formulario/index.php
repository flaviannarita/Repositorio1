...
<input type="text" name="descricao" id="descricao" placeholder="Informe o nome do produto" size="50"><br><br>
	 
	 <label>Quantidade: </label>
<input type="number" name="quantidade" id="quantidade" placeholder="Informe a quantidade" size="11"><br><br>

<label>Preço: </label>
<input type="text" name="preco" id="preco" placeholder="Informe o preco" size="11"><br><br>
...
<label>Nome: </label>
<input type="text" name="prod" id="prod" placeholder="Informe o nome do produto" size="50"><br><br>
...
foreach($data as $d)
echo
"<tr><td>".$d['id']."</td><td>".$d['descricao']."</td><td>".$d['quantidade']."</td><td>".$d['preco']."</td></tr>";
echo "</table>";
mysqli_close($con);
//var_dump($d);
}
